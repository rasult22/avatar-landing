...
{#if show}
  <div transition:fade class="bg-[#091720] w-[100vw] h-[100vh] fixed left-0 top-0">
    <div class="max-w-[1264px] mx-auto">
        <div class="flex justify-between py-12">
          <img class="max-w-[206px]" width="206" src="/optimized/logo.webp" alt="logo">
          <svg class="cursor-pointer" on:click={toggleShow} xmlns="http://www.w3.org/2000/svg" width="45" height="45" viewBox="0 0 45 45" fill="none">
      ...
      {#if !sumbitted}
        <div class="flex mt-[72px] items-center justify-center space-x-[110px] px-[80px]">
          <div>
            <div class="text-[48px] font-semibold leading-[120%]">
              Whitelist <br/>
              application
            </div>
            <div class="text-[20px] mt-[16px]">
          ...
          <div class="">
            <img class="max-w-[496px]" width="496" src="/whitelist-img.png" alt="">
          </div>
        </div>
      {:else}
        <div class="flex flex-col min-h-[80vh] justify-center py-12 items-center">
          ...
          <button on:click={toggleShow} class="mt-8 px-8 disabled:opacity-55 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
            Ok
          </button>
        </div>
      {/if}
